...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x22, 0xb6, 0x04, 0x0a, 0x09, 0x50, 0x6f, 0x63, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2d,
	...
	0x65, 0x73, 0x74, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x41, 0x0a, 0x07, 0x44, 0x65, 0x63,
	...
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x42, 0xb9, 0x01, 0x0a,
...
var file_inference_inference_params_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
...
var file_inference_inference_params_proto_depIdxs = []int32{
	...
	8,  // 12: inference.inference.GenesisOnlyParams.max_individual_power_percentage:type_name -> inference.inference.Decimal
	8,  // 13: inference.inference.GenesisOnlyParams.genesis_guardian_multiplier:type_name -> inference.inference.Decimal
	8,  // 14: inference.inference.TokenomicsParams.subsidy_reduction_interval:type_name -> inference.inference.Decimal
	8,  // 15: inference.inference.TokenomicsParams.subsidy_reduction_amount:type_name -> inference.inference.Decimal
	8,  // 16: inference.inference.TokenomicsParams.current_subsidy_percentage:type_name -> inference.inference.Decimal
	8,  // 17: inference.inference.TokenomicsParams.top_reward_allowed_failure:type_name -> inference.inference.Decimal
